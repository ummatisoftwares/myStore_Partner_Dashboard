...
Route::controller(LoginRegisterController::class)->group(function() {
    ...
    Route::get('/dashboard/index', 'dashboard')->name('index');
...
Route::view('orders', 'order.orders')->name('orders');
Route::view('ordercreate', 'order.ordercreate')->name('ordercreate');
});

// Route::view('store_settings', 'store.store_settings')->name('store_settings');
Route::get('/store_settings', [StoreSettingController::class, 'storeSettings'])->name('store_settings');
Route::post('/store-settings/save', [StoreSettingController::class, 'saveSettings'])->name('store-settings.save');

Route::get('/edit-profile', [UsersController::class, 'editProfile'])->name('edit-profile');
Route::post('/update-profile', [UsersController::class, 'updateProfile'])->name('update-profile');
Route::post('/save-profile', [UsersController::class, 'saveProfile'])->name('save-profile');

Route::view('product_groups', 'ProductGroups.product_groups')->name('product_groups');
Route::view('productgroupscreate', 'ProductGroups.productgroupscreate')->name('productgroupscreate');


Route::get('/product_groups', [ProductGroupsController::class, 'productGroups'])->name('product_groups');
Route::post('/productgroupscreate', [ProductGroupsController::class, 'createProductGroups'])->name('productgroupscreate');

// PRODUCT GROUPS
Route::get('/product_groups', [ProductGroupsController::class, 'productGroups'])->name('product_groups');
Route::get('/productgroups/create', [ProductGroupsController::class, 'create'])->name('productgroupscreate');
Route::post('/productgroups/store', [ProductGroupsController::class, 'store'])->name('productgroupsstore');
Route::get('/productgroups/{id}/edit', [ProductGroupsController::class, 'edit'])->name('productgroupsedit');
Route::put('/productgroups/{id}/update', [ProductGroupsController::class, 'update'])->name('productgroupsupdate');
Route::delete('/productgroups/{id}/destroy', [ProductGroupsController::class, 'destroy'])->name('productgroupsdestroy');


// PRODUCT CATEGORIES
Route::get('/product_categories', [ProductCategoriesController::class, 'productCategories'])->name('product_categories');
Route::get('/productcategories/create', [ProductCategoriesController::class, 'create'])->name('productcategoriescreate');
Route::post('/productcategories/store', [ProductCategoriesController::class, 'store'])->name('productcategoriesstore');
Route::get('/productcategories/{id}/edit', [ProductCategoriesController::class, 'edit'])->name('productcategoriesedit');
Route::put('/productcategories/{id}/update', [ProductCategoriesController::class, 'update'])->name('productcategoriesupdate');
Route::delete('/productcategories/{id}/destroy', [ProductCategoriesController::class, 'destroy'])->name('productcategoriesdestroy');


// PRODUCTS
Route::get('/products', [ProductsController::class, 'products'])->name('products');
Route::get('/product/create', [ProductsController::class, 'create'])->name('productscreate');
Route::post('/products/store', [ProductsController::class, 'store'])->name('productsstore');
Route::get('/products/{id}/edit', [ProductsController::class, 'edit'])->name('productsedit');
Route::put('/products/{id}/update', [ProductsController::class, 'update'])->name('productsupdate');
Route::delete('/products/{id}/destroy', [ProductsController::class, 'destroy'])->name('productsdestroy');

Route::post('/products/add_attribute', [ProductsController::class, 'addProductAttributes'])->name('addProductAttributes');


// SOCIAL LINKS
Route::get('/social_links', [SocialsController::class, 'socialLinks'])->name('sociallinks');
Route::get('/social_links/create', [SocialsController::class, 'create'])->name('sociallinkscreate');
Route::post('/social_links/store', [SocialsController::class, 'store'])->name('sociallinksstore');
Route::get('/social_links/{id}/edit', [SocialsController::class, 'edit'])->name('sociallinksedit');
Route::put('/social_links/{id}/update', [SocialsController::class, 'update'])->name('sociallinksupdate');
Route::delete('/social_links/{id}/destroy', [SocialsController::class, 'destroy'])->name('sociallinksdestroy');
Route::post('/update-social-status', [SocialsController::class, 'updateStatus']);

// SOCIAL LINKS
Route::get('/affiliates', [AffiliatesController::class, 'affiliates'])->name('affiliates');


// FEEDBACK
// Route::get('/feedback', [FeedbackController::class, 'feedback'])->name('feedback');
Route::get('/feedbacks/create', [FeedbackController::class, 'create'])->name('feedbackscreate');
Route::post('/feedbacks/store', [FeedbackController::class, 'store'])->name('feedbacksstore');


// Orders
Route::get('/orders', [OrdersController::class, 'orders'])->name('orderslistings');
