...
@section('title', 'Product Groups Edit')
...
<h3>Product Groups Edit</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item">Product Groups</li>
<li class="breadcrumb-item active">Product Groups Edit</li>
@endsection
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-6">
            <form class="card" method="POST" action="{{ route('productgroupsupdate', $productGroup->id) }}">
                @csrf
                @method('PUT')
                <div class="card-body">
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="name"
                                        value="{{ old('name', $productGroup->name) }}" type="text"
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 selected-products-container">
                                    ...
                                    @foreach($productGroup->products as $selectedProduct)
                                    <div class="prooduct-details-box m-2" data-product-id="{{ $selectedProduct->id }}">
                                        <div class="media">
                                            ...
                                            <div class="media-body ms-3">
                                                <div class="product-name">
                                                    <h6><a href="#" data-bs-original-title=""
                                                            title="">{{ $selectedProduct->product_name }}</a></h6>
                                                </div>
                                                <div class="price d-flex">
                                                    <div class="text-muted me-2">Price</div>:
                                                    {{ $selectedProduct->price }}$
                                                    <div class="text-muted me-2">
                                                        <a class="btn btn-danger btn-xs remove-from-group-btn" href="#"
                                                            data-bs-original-title="" title="">Remove from Group</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body ms-3">
                                        ...
                                        <div class="price d-flex">
                                            ...
                                            <div class="text-muted me-2"><a
                                                    class="btn btn-primary btn-xs add-to-group-btn" href="#"
